...
export class LanguagesPageComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.products = this.productService.languagesProductsInMainPage
  ...
  offerLableClick(){
    ...
    this.offerFilteredProducts =  this.productService.languagesProductsInMainPage.filter(item => item.Discount !== 0)
    ...
    if(!this.checkBoxOfferLable.nativeElement.className.includes('checkBoxActive')){
      ...
      if(this.inputElemMinPrice.nativeElement.value != 0){
        ...
        this.products = this.productService.languagesProductsInMainPage.filter(item => item.price >= Number(this.inputElemMinPrice.nativeElement.value))
  ...
  changeInputRange(event:any){
    ...
    this.rangePriceFilteredProducts = this.productService.languagesProductsInMainPage.filter( item => item.price >= Number(this.inputElemMinPrice.nativeElement.value))
  ...
  sendSpecialClick(){
    ...
    this.sendSpecialFilteredProducts = this.productService.languagesProductsInMainPage.filter(item => item.fastSending === true)
