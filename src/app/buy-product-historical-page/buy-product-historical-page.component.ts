...
@Component({
  selector: 'app-buy-product-historical-page',
  templateUrl: './buy-product-historical-page.component.html',
  styleUrls: ['./buy-product-historical-page.component.css']
})
export class BuyProductHistoricalPageComponent {
  ...
  ngOnInit(): void {
    ...
    this.products = this.productService.historicalProductsInMainPage.filter(item => item.id === this.productId)
