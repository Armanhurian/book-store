...
@Component({
  selector: 'app-buy-product-romance-page',
  templateUrl: './buy-product-romance-page.component.html',
  styleUrls: ['./buy-product-romance-page.component.css']
})
export class BuyProductRomancePageComponent {
  ...
  ngOnInit(): void {
    ...
    this.products = this.productService.romanceProductsInMainPage.filter(item => item.id === this.productId)
