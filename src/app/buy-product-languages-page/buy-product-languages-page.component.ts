...
@Component({
  selector: 'app-buy-product-languages-page',
  templateUrl: './buy-product-languages-page.component.html',
  styleUrls: ['./buy-product-languages-page.component.css']
})
export class BuyProductLanguagesPageComponent {
  ...
  ngOnInit(): void {
    ...
    this.products = this.productService.languagesProductsInMainPage.filter(item => item.id === this.productId)
