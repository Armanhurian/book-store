...
@Component({
  selector: 'app-buy-product-education-page',
  templateUrl: './buy-product-education-page.component.html',
  styleUrls: ['./buy-product-education-page.component.css']
})
export class BuyProductEducationPageComponent {
  ...
  ngOnInit(): void {
    ...
    this.products = this.productService.educationProductsInMainPage.filter(item => item.id === this.productId)
