...
@Component({
  selector: 'app-romance-page',
  templateUrl: './romance-page.component.html',
  styleUrls: ['./romance-page.component.css']
})
export class RomancePageComponent implements OnInit {
  ...
  clickSearchHandler(){
    ...
    this.products = this.productService.romanceProductsInMainPage.filter(item => item.title.includes(this.myInputSearchValue.nativeElement.value))
  ...
  ngOnInit(): void {
    ...
    this.products = this.productService.romanceProductsInMainPage
  ...
  offerLableClick(){
    ...
    this.offerFilteredProducts =  this.productService.romanceProductsInMainPage.filter(item => item.Discount !== 0)
    ...
    if(!this.checkBoxOfferLable.nativeElement.className.includes('checkBoxActive')){
      ...
      if(this.inputElemMinPrice.nativeElement.value != 0){
        ...
        this.products = this.productService.romanceProductsInMainPage.filter(item => item.price >= Number(this.inputElemMinPrice.nativeElement.value))
  ...
  changeInputRange(event:any){
    ...
    this.rangePriceFilteredProducts = this.productService.romanceProductsInMainPage.filter( item => item.price >= Number(this.inputElemMinPrice.nativeElement.value))
  ...
  sendSpecialClick(){
    ...
    this.sendSpecialFilteredProducts = this.productService.romanceProductsInMainPage.filter(item => item.fastSending === true)
