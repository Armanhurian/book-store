...
export class EducationPageComponent implements OnInit {
  ...
  clickSearchHandler(){
    ...
    this.products = this.productService.educationProductsInMainPage.filter(item => item.title.includes(this.myInputSearchValue.nativeElement.value))
  ...
  ngOnInit(): void {
    ...
    this.products = this.productService.educationProductsInMainPage
  ...
  offerLableClick(){
    ...
    this.offerFilteredProducts =  this.productService.educationProductsInMainPage.filter(item => item.Discount !== 0)
    ...
    if(!this.checkBoxOfferLable.nativeElement.className.includes('checkBoxActive')){
      ...
      if(this.inputElemMinPrice.nativeElement.value != 0){
        ...
        this.products = this.productService.educationProductsInMainPage.filter(item => item.price >= Number(this.inputElemMinPrice.nativeElement.value))
  ...
  changeInputRange(event:any){
    ...
    this.rangePriceFilteredProducts = this.productService.educationProductsInMainPage.filter( item => item.price >= Number(this.inputElemMinPrice.nativeElement.value))
  ...
  sendSpecialClick(){
    ...
    this.sendSpecialFilteredProducts = this.productService.educationProductsInMainPage.filter(item => item.fastSending === true)
