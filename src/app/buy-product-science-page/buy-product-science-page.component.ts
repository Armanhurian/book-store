...
@Component({
  selector: 'app-buy-product-science-page',
  templateUrl: './buy-product-science-page.component.html',
  styleUrls: ['./buy-product-science-page.component.css']
})
export class BuyProductSciencePageComponent {
  ...
  ngOnInit(): void {
    ...
    this.products = this.productService.scienceProductsInMainPage.filter(item => item.id === this.productId)
